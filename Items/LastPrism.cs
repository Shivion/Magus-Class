...
namespace MagusClass.Items
{
    ...
    internal class LastPrismHoldout : MagusProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            base.SetDefaults();
            buffID = ModContent.BuffType<LastPrismBuff>();
    ...
    internal class LastPrismLaser : ModProjectile
    {
        ...
        private const float PiBeamDivisor = MathHelper.Pi / LastPrismHoldout.NumBeams;
        ...
        private const float BeamLightBrightness = 1;//0.75f;
        ...
        public override void AI()
        {
            ...
            if (Projectile.type != ModContent.ProjectileType<LastPrismLaser>() || !hostPrism.active || hostPrism.type != ModContent.ProjectileType<LastPrismHoldout>())
            {
                Projectile.Kill();
                return;
            }
            ...
            float chargeRatio = MathHelper.Clamp(hostPrism.ai[0] / LastPrismHoldout.MaxCharge, 0f, 1f);
            ...
            Projectile.friendly = hostPrism.ai[0] > LastPrismHoldout.DamageStart;

            // This offset is used to make each individual beam orient differently based on its Beam ID.
            float beamIdOffset = BeamID - LastPrismHoldout.NumBeams / 2f + 0.5f;
            float beamSpread;
            float spinRate;
            ...
            float deviationAngle = (hostPrism.ai[0] + beamIdOffset * spinRate) / (spinRate * LastPrismHoldout.NumBeams) * MathHelper.TwoPi;
        ...
        private Color GetOuterBeamColor()
        {
            ...
            float hue = (BeamID / LastPrismHoldout.NumBeams) % BeamHueVariance + BeamColorHue;
